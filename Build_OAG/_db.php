...
if (!$db_exists) {
    ...
    $rooms = array(
                    array('name' => 'Haribabu Nutheti',
                        'id' => 1,
                        'capacity' => 1,
						'password' => 'anshuman@',
                        'status' => ''),
                    array('name' => 'Anil Narayana Murthy',
                        'id' => 2,
                        'capacity' => 1,
                        'status' => ""),
                    array('name' => 'Amit Kum',
                        ...
                        'capacity' => 1,
                        'status' => "Ready"),
                    array('name' => 'Geetha Pushparaj',
                        'id' => 4,
                        'capacity' => 1,
                        'status' => "Ready"),
						array('name' => 'Ravi Kapa',
                        'id' => 5,
                        'capacity' => 1,
                        'status' => "Ready"),
						array('name' => 'Ganesh Athmagnanam',
                        'id' => 6,
                        'capacity' => 1,
                        'status' => "Ready"),
