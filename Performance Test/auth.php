...
<style>
body  {
    background-image: url("vac2.jpg");
	 background-size: 1365px 665px;
...
<h1>PCEHR PERFORMANCE VACATION ADMIN</h1>
...
class OneFileLoginApplication
{
    ...
    private function performMinimumRequirementsCheck()
    {
        if (version_compare(PHP_VERSION, '5.3.7', '<')) {
            echo "Sorry,  PHP Login does not run on a PHP version older than 5.3.7 !";
    ...
    private function showPageLoginForm()
    {
        ...
        echo '<label for="login_input_username">Username (or email)</label> <br/>';
		
        echo '<input id="login_input_username" type="text" name="user_name" required /> <br/>';
        echo '<label for="login_input_password"><br/>Password</label><br/> ';
        echo '<input id="login_input_password" type="password" name="user_password" required /><br/><br/> ';
        echo '<input type="submit"  name="login" value="Log in" /><br/>';
        echo '</form>';
